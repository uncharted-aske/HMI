...
import DSSATPetasceGrFN from '../assets/formatted-PETASCE-GrFN.json'
import DSSATPetdynCAG from '../assets/formatted-PETDYN-CAG.json'
import DSSATPetdynGrFN from '../assets/formatted-PETDYN-GrFN.json'

import SIRCAG from '../assets/formatted-SIR-simple-CAG.json'
import SIRGrFN from '../assets/formatted-SIR-simple-GrFN.json'
