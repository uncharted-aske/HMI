...
export abstract class ProvenanceData {
    ...
    static readonly SINGLE_MODEL_CONDENSED: GraphInterface = ({
      nodes: [{ id: 'Box 0', label: '', parent: null },
        { id: 'Select', label: 'Select', role: ['Operation'], parent: 'Box 0', nodeType: '2021-08-27T11:00:00' },
        { id: 'Box 1', label: '', parent: 'Box 0' },
        { id: 'Edit 1', label: 'Edit', role: ['Operation'], parent: 'Box 1', nodeType: '2021-08-27T11:01:00' },
        { id: 'Execute 1', label: 'Execute', role: ['Operation'], parent: 'Box 1', nodeType: '2021-08-27T11:02:00' },
        { id: 'Box 2', label: '', parent: 'Box 0' },
        { id: 'Edit 2', label: 'Edit', role: ['Operation'], parent: 'Box 2', nodeType: '2021-08-27T11:03:00' },
        { id: 'Execute 2', label: 'Execute', role: ['Operation'], parent: 'Box 2', nodeType: '2021-08-27T11:04:00' },
        { id: 'Box 3', label: '', parent: 'Box 0' },
        { id: 'Edit 3', label: 'Edit', role: ['Operation'], parent: 'Box 3', nodeType: '2021-08-27T11:05:00' },
        { id: 'Execute 3', label: 'Execute', role: ['Operation'], parent: 'Box 3', nodeType: '2021-08-27T11:06:00' },
      ],
    ...
    static readonly SINGLE_MODEL_EXPANDED: GraphInterface = ({
      nodes: [{ id: 'Box 0', label: '', parent: null },
        ...
        { id: 'Model', label: 'Model', role: ['Data'], parent: 'Box 1', nodeType: 'SIR' },
        { id: 'Param:v0', label: 'Param:v0', role: ['Data'], parent: 'Box 1', nodeType: 'S: 997\nI: 3\nR:1' },
        { id: 'Param:v1', label: 'Param:v1', role: ['Data'], parent: 'Box 1', nodeType: 'S: 998\nI: 2\nR:1' },
        { id: 'Variables:v1', label: 'Variables:v1', role: ['Data'], parent: 'Box 1', nodeType: 'S_avg: 997\nI_avg: 1\nR_avg:1' },
        { id: 'Param:v2', label: 'Param:v2', role: ['Data'], parent: 'Box 2', nodeType: 'S: 996\nI: 4\nR:1' },
        { id: 'Variables:v2', label: 'Variables:v2', role: ['Data'], parent: 'Box 2', nodeType: 'S_avg: 997\nI_avg: 1\nR_avg:1' },
        { id: 'Param:v3', label: 'Param:v3', role: ['Data'], parent: 'Box 3', nodeType: 'S: 990\nI: 10\nR:1' },
        { id: 'Variables:v3', label: 'Variables:v3', role: ['Data'], parent: 'Box 3', nodeType: 'S_avg: 997\nI_avg: 1\nR_avg:1' },
      ],
    ...
    static readonly MULTI_MODEL_CONDENSED: GraphInterface = ({
      nodes: [{ id: 'Box 0', label: '', parent: null },
        { id: 'Select', label: 'Select', role: ['Operation'], parent: 'Box 0', nodeType: '2021-08-27T11:00:00' },
        { id: 'Box 1', label: '', parent: 'Box 0' },
        { id: 'Edit 1a', label: 'Edit', role: ['Operation'], parent: 'Box 1', nodeType: '2021-08-27T11:01:00' },
        { id: 'Edit 1b', label: 'Edit', role: ['Operation'], parent: 'Box 1', nodeType: '2021-08-27T11:01:00' },
        { id: 'Execute 1', label: 'Execute', role: ['Operation'], parent: 'Box 1', nodeType: '2021-08-27T11:02:00' },
        { id: 'Box 2', label: '', parent: 'Box 0' },
        { id: 'Edit 2a', label: 'Edit', role: ['Operation'], parent: 'Box 2', nodeType: '2021-08-27T11:03:00' },
        { id: 'Edit 2b', label: 'Edit', role: ['Operation'], parent: 'Box 2', nodeType: '2021-08-27T11:03:00' },
        { id: 'Execute 2', label: 'Execute', role: ['Operation'], parent: 'Box 2', nodeType: '2021-08-27T11:04:00' },
        { id: 'Box 3', label: '', parent: 'Box 0' },
        { id: 'Edit 3a', label: 'Edit', role: ['Operation'], parent: 'Box 3', nodeType: '2021-08-27T11:05:00' },
        { id: 'Edit 3b', label: 'Edit', role: ['Operation'], parent: 'Box 3', nodeType: '2021-08-27T11:05:00' },
        { id: 'Execute 3', label: 'Execute', role: ['Operation'], parent: 'Box 3', nodeType: '2021-08-27T11:06:00' },
      ],
      edges: [{ source: 'Select', target: 'Execute 1' },
    ...
    static readonly MULTI_MODEL_EXPANDED: GraphInterface = ({
      nodes: [{ id: 'Box 0', label: '', parent: null },
        ...
        { id: 'Execute 3', label: 'Execute', role: ['Operation'], parent: 'Box 3', nodeType: '2021-08-27T11:06:00' },
        { id: 'Models', label: 'Models', role: ['Data'], parent: 'Box 0' },
        { id: 'Model 1a', label: 'Model', role: ['Data'], parent: 'Box 1', nodeType: 'SIR' },
        { id: 'Model 1b', label: 'Model', role: ['Data'], parent: 'Box 1', nodeType: 'SEIR' },
        { id: 'Param a:v0', label: 'Param:v0', role: ['Data'], parent: 'Box 1', nodeType: 'S: 997\nI: 3\nR:1' },
        { id: 'Param b:v0', label: 'Param:v0', role: ['Data'], parent: 'Box 1', nodeType: 'S: 997\nI: 3\nR:1' },
        { id: 'Param a:v1', label: 'Param:v1', role: ['Data'], parent: 'Box 1', nodeType: 'S: 998\nI: 2\nR:1' },
        { id: 'Param b:v1', label: 'Param:v1', role: ['Data'], parent: 'Box 1', nodeType: 'S: 998\nI: 2\nR:1' },
        { id: 'Variables a:v1', label: 'Variables:v1', role: ['Data'], parent: 'Box 1', nodeType: 'S_avg: 997\nI_avg: 1\nR_avg:1' },
        { id: 'Variables b:v1', label: 'Variables:v1', role: ['Data'], parent: 'Box 1', nodeType: 'S_avg: 997\nI_avg: 1\nR_avg:1' },
        { id: 'Param a:v2', label: 'Param:v2', role: ['Data'], parent: 'Box 2', nodeType: 'S: 996\nI: 4\nR:1' },
        { id: 'Param b:v2', label: 'Param:v2', role: ['Data'], parent: 'Box 2', nodeType: 'S: 996\nI: 4\nR:1' },
        { id: 'Variables a:v2', label: 'Variables:v2', role: ['Data'], parent: 'Box 2', nodeType: 'S_avg: 997\nI_avg: 1\nR_avg:1' },
        { id: 'Variables b:v2', label: 'Variables:v2', role: ['Data'], parent: 'Box 2', nodeType: 'S_avg: 997\nI_avg: 1\nR_avg:1' },
        { id: 'Param a:v3', label: 'Param:v3', role: ['Data'], parent: 'Box 3', nodeType: 'S: 990\nI: 10\nR:1' },
        { id: 'Param b:v3', label: 'Param:v3', role: ['Data'], parent: 'Box 3', nodeType: 'S: 990\nI: 10\nR:1' },
        { id: 'Variables a:v3', label: 'Variables:v3', role: ['Data'], parent: 'Box 3', nodeType: 'S_avg: 997\nI_avg: 1\nR_avg:1' },
        { id: 'Variables b:v3', label: 'Variables:v3', role: ['Data'], parent: 'Box 3', nodeType: 'S_avg: 997\nI_avg: 1\nR_avg:1' },
      ],
      edges: [{ source: 'Models', target: 'Select' },
